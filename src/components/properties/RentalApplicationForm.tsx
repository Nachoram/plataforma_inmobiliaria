...
const RentalApplicationForm: React.FC<RentalApplicationFormProps> = ({
    ...
    try {
      ...
      const { data: application, error: applicationError } = await supabase
        ...
        .insert({
          ...
          snapshot_applicant_monthly_income_clp: parseInt(applicantData.monthly_income_clp),
          snapshot_applicant_age: parseInt(applicantData.age),
  ...
  const renderStep2 = () => (
    <div className="space-y-6">
      <h3 className="text-lg font-semibold text-gray-800">Información Laboral y Contacto</h3>
  ...
  const renderStep3 = () => (
    <div className="space-y-6">
      <h3 className="text-lg font-semibold text-gray-800">Aval (Opcional)</h3>
  ...
  const renderStep4 = () => (
    <div className="space-y-6">
      <h3 className="text-lg font-semibold text-gray-800">Documentos y Mensaje</h3>
        ...
        <div className="flex space-x-4">
          ...
          {currentStep < 4 ? (
            <button
              type="button"
              onClick={nextStep}
              className="px-6 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            >
              Siguiente
            </button>
          ) : (
            <button
              ...
              disabled={loading}
              className="px-6 py-3 bg-green-600 text-white rounded-md hover:bg-green-700 focus:ring-2 focus:ring-green-500 focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed"
            >
