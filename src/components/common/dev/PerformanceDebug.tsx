...
/**
 * Props for the PerformanceDebug component
 */
...
/**
 * A development-only component that displays performance metrics and Core Web Vitals.
 * Shows LCP, FID, CLS metrics and recent performance events.
