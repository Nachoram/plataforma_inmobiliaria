-- ============================================================
-- FIX: Column names in get_portfolio_with_postulations
-- ============================================================
-- PROBLEMA: La función RPC está intentando acceder a columnas que no existen en la tabla guarantors
-- - Intenta usar: guar.email, guar.phone, guar.first_name, guar.paternal_last_name, guar.maternal_last_name
-- - Pero la tabla tiene: contact_email, contact_phone, full_name
--
-- SOLUCION: Actualizar la función RPC para usar los nombres de columnas correctos
-- ============================================================
        ...
        COALESCE(
            (
                SELECT json_agg(json_build_object(
                    ...
                    -- ✅ FIXED: Use correct guarantor column names from guarantors table
                    'guarantor_name', guar.full_name,  -- ✅ was: first_name + paternal_last_name + maternal_last_name
                    'guarantor_email', guar.contact_email,  -- ✅ was: guar.email
                    'guarantor_phone', guar.contact_phone,  -- ✅ was: guar.phone
                    'guarantor_characteristic_id', app.guarantor_characteristic_id  -- ✅ was: guar.guarantor_characteristic_id (this is in applications table)
