-- CORRECCIÓN: Constraint check_contract_has_content requiere contenido
-- Se inicializa contract_content con JSON vacío '{}' para cumplir la constraint
...
BEGIN
    ...
    INSERT INTO rental_contracts (
        ...
        '{}'::jsonb, -- contract_content (JSON vacío inicialmente, se genera después)
