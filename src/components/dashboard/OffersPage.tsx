...
import { Check, X, Clock, DollarSign, Calendar, MapPin } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-xl shadow-sm border p-6">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Ofertas Recibidas</h1>
        <p className="text-gray-600">
          Gestiona las ofertas de compra para tus propiedades en venta
        </p>
      </div>
      ...
      {offers.length === 0 ? (
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">No hay ofertas aún</h3>
