-- ============================================================================
-- SCRIPT PARA APLICAR: Agregar updated_at y columnas faltantes a applications
-- Ejecutar este script COMPLETO en Supabase SQL Editor
-- Resolverá el error: "Could not find the 'updated_at' column"
-- ============================================================================
...
BEGIN
  ...
  FOR column_record IN
    ...
    WHERE table_schema = 'public'
    AND table_name = 'applications'
    AND column_name NOT LIKE 'snapshot_%'  -- Ocultar columnas snapshot para resumen
  ...
  RAISE NOTICE '';
  RAISE NOTICE '📊 Columnas principales: %', column_count;
  RAISE NOTICE '📸 Columnas snapshot añadidas: 16';
