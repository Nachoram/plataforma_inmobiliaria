...
--
-- Maneja colisiones actualizando datos existentes
-- Crea perfiles de demostración independientes

-- =====================================================
-- 1. INSERTAR USUARIOS EN PROFILES
-- =====================================================

-- Arrendador (Owner) - Crear un nuevo perfil de demostración
...
-- Arrendatario (Applicant) - Si el RUT ya existe, actualiza el registro existente
INSERT INTO profiles (id, first_name, paternal_last_name, maternal_last_name, rut, email, phone, profession, marital_status, address_street, address_number, address_commune, address_region)
VALUES
