...
/**
 * Available button variants for styling
 */
...
interface CustomButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  ...
  fullWidth?: boolean;
  /** Optional href to render as an anchor link instead of button */
  href?: string;
  /** The button content */
 ...
 * @example
 * ```tsx
 * <CustomButton variant="primary" size="lg" loading={isSubmitting}>
 *   Submit Form
 * </CustomButton>
 *
