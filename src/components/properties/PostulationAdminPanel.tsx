...
/**
 * Datos completos de una postulación
 */
...
export const PostulationAdminPanel: React.FC<PostulationAdminPanelProps> = ({ 
  ...
  const fetchPostulations = async () => {
    ...
    try {
      ...
      console.log('✅ [PostulationAdminPanel] Postulaciones cargadas:', data?.length || 0);
      ...
      console.log('📊 [PostulationAdminPanel] Postulaciones formateadas:', formattedPostulations);
  ...
  const handleSaveModification = async () => {
    ...
    try {
      ...
      // Por ahora, actualizamos la tabla applications con campos de modificación
      
      const updateData: any = {
        // TODO: Agregar estos campos a la tabla applications en una migración futura
