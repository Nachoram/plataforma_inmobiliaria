-- Emergency fix for "column guar.email does not exist" error
-- This script applies the correct guarantor column names to the RPC function
...
SELECT 'Function get_portfolio_with_postulations has been updated successfully' as status;
